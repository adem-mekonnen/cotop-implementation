...
Persists task arrival timestamps, task characteristics, vehicle trajectories, mobility states,
initial conditions, RSU configurations, workload configurations, seed, and geometry.
"""
...
class RealizationGenerator:
    """
    Generates fully specified, deterministic evaluation realizations.
    """
    ...
    def generate_realization(
        ...
        """
        Generates a complete ExperimentRealization.
        """
        ...
        for v in range(num_vehicles):
            ...
            # Mobility Dwell Time Calculations per RSU
            dwell_times = {}
            for r_idx, r_cfg in enumerate(rsu_configs):
                r_loc = r_cfg["location"]
                # Approximate dwell time within RSU radius (400m)
            ...
            # Proximity neighbors within 200m
        ...
        # 6. Environment Configuration & Physics Locks
